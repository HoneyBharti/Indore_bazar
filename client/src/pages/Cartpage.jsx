...
import { createorder, getcart, removeitemfromcart, updatecart } from "../features/cart/cartslice"
...
export default function Cartpage() {
    ...
    const { cartitems, cartloading, carterror, carterrormsg } = useSelector(state => state.cart)
    ...
    const handleRemoveItemFromCart = (pid) => {
        console.log(pid)
        dispatch(removeitemfromcart(pid))
    }
    ...
    useEffect(() => {
        ...
        if (carterror && carterrormsg) {
            toast.error(carterrormsg)
        }


    }, [carterror, carterrormsg])
