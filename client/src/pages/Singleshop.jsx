...
import { getallproducts, getsingleshop } from "../features/product/productslice"
...
export default function Singleshop() {
    ...
    const { products, shop , productloading, productsuccess, producterror, producterrormsg } = useSelector(state => state.product)
    const dispatch = useDispatch()


    const shopProducts = products?.filter((product => product.shop?._id === shop?._id))
    ...
    }, [producterror, producterrormsg, sid])
            ...
            <main className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
                    ...
                    <div className="grid md:grid-cols-2 gap-4 mt-6">
                        <div className="flex items-start gap-3 bg-white rounded-lg p-4 border border-gray-200">
                            ...
                            <div>
                                ...
                                <p className="text-sm text-gray-900 mt-1">{shop.address}</p>
                            </div>
                        </div>
                        <div className="flex items-start gap-3 bg-white rounded-lg p-4 border border-gray-200">
                            ...
                            <div>
                                ...
                                <p className="text-sm text-gray-900 mt-1">{shop.shopphone}</p>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div className="mb-12">
                    <div className="flex items-center justify-between mb-8">
                        <h2 className="text-3xl font-bold text-gray-900">Products from {shop.name}</h2>
