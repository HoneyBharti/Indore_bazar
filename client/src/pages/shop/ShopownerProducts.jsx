...
import { getshopproducts, productedit } from '../../features/shop/shopslice';
...
const {shop , shoploading , shoperror , shoperrormsg , shopproducts , shopsuccess} = useSelector(state=> state.shop)
 ...
 return( <Loader/>)
  ...
  return (
    <ShopOwnerLayout activePage="Products">
     ...
     { showmodal && <Addproductmodal showmodal={setshowmodal} handlemodal={handlemodal}/>}
            ...
            <tbody className="divide-y divide-slate-200">
            {
              shopproducts?.map(product=>{
                ...
                <td className="px-6 py-4">
                  <div style={{backgroundImage : `url(${product?.productImage})`}} className="w-12 h-12 bg-slate-100 rounded-lg flex items-center justify-center bg-cover bg-center">
                  </div>
                </td>
                <td className="px-6 py-4">
