...
import RequestShopowner from "../components/shop/RequestShopowner"
...
export default function Profilepage() {
    ...
    return (
        <div className="min-h-screen bg-slate-50/50 p-4 md:p-8 font-sans text-slate-900">
            {
                showModal && <Orderdetailsmodal orderdetails={orderdetails} handleorderdetail={handleorderdetail} />
            }
                                ...
                                <div className="overflow-x-auto">
                                    <table className="w-full text-left text-sm">
                                        ...
                                        <tbody className="divide-y divide-slate-100">
                                            {orders.map((order) => (
                                                <>
                                                    <tr onClick={() => handleorderdetail(order)} key={order._id} className="group cursor-pointer transition-colors hover:bg-slate-50/50">
