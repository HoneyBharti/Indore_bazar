...
function Orderdetailsmodal({ handleorderdetail , orderdetails}) {
    ...
    const handleupdate=(orderdetails)=>{
                        ...
                        <div className="px-6 py-4">
                            ...
                            {orderData.status === 'placed' && (
                                <div className="flex flex-col sm:flex-row gap-3 mt-4">
                                    {
                                        user.isShopowner && <button onClick={() => handleupdate({ id: orderData.orderId, status: "dispatched" })} className="flex-1 px-6 py-3 bg-emerald-600 hover:bg-emerald-700 text-white font-semibold rounded-lg transition-colors duration-200 shadow-sm hover:shadow-md">
                                            Dispatch Order
                                        </button>
                                    }
                                    <button onClick={() => handleupdate({ id: orderData.orderId, status: "cancelled" })} className="flex-1 px-6 py-3 bg-red-600 hover:bg-red-700 text-white font-semibold rounded-lg transition-colors duration-200 shadow-sm hover:shadow-md">
                                        Cancel Order
                                    </button>
                                </div>
                            )}

                            {
                                user.isShopowner && orderData.status === 'dispatched' && (
                                    <div className="mt-4">
                                        ...
                                        <button
                                            onClick={() => handleupdate({ id: orderData.orderId, status: "delivered" })}
